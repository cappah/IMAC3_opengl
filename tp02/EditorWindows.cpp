...
DroppedFileEditorFrame::DroppedFileEditorFrame(Editor* editorRef) 
	: EditorFrame("DroppedFilesPopUp")
	, m_editorRef(editorRef)
{
	assert(editorRef != nullptr);
	treeView.setModel(m_editorRef->getResourceTree());
}
//
...
ViewportEditorFrame::ViewportEditorFrame()
	: EditorFrame("Viewport")
{
}
...
TerrainToolEditorFrame::TerrainToolEditorFrame() 
	: EditorFrame("TerrainTool")
{}
...
SkyboxToolEditorFrame::SkyboxToolEditorFrame() 
	: EditorFrame("SkyboxTool")
{}
...
SceneManagerEditorFrame::SceneManagerEditorFrame() 
	: EditorFrame("SceneManager")
{}
...
FactoriesDebugEditorFrame::FactoriesDebugEditorFrame() 
	: EditorFrame("FactoriesDebug")
{
	hideAllDebugViews();
