...
{
public:
	enum ComponentType { COLLIDER, MESH_RENDERER, POINT_LIGHT, DIRECTIONAL_LIGHT, SPOT_LIGHT, FLAG, PARTICLE_EMITTER, PATH_POINT, BILLBOARD, CAMERA, WIND_ZONE, RIGIDBODY, INTERNAL_COMPONENT_COUNT, BEHAVIOR, LIGHT, NONE };
